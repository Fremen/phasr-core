...
export function buildPlanningPrompt(task, mode, minutes) {
  return [
    ...
    'Each main step must be a small physical action that can be started in about two minutes.',
    'Each tiny alternative must be an even smaller first movement that can be done in under one minute.',
